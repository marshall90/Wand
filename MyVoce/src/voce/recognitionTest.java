...
public class recognitionTest
{
	...
	public static void wiigee(){
		WiimoteWiigee wiigee = new WiimoteWiigee();
		//while (wiigee.getNumberOfDevices()  == 0
		...
		MyGestureListener mel = new MyGestureListener();
		//wiigee.addWiimoteListener(mel);
		try {
			Wiimote wm = wiigee.getDevice();
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		wiigee.addGestureListener(mel);
	}
}
